...
def _jit_deserialize_SerializeNestedSchema_1(
                            self,
                            data: (
            ...
            if value is missing:
                ...
                if value is not None:
                    ...
                    if isinstance(value, (list, tuple)):
                        result_2 = []
                        for item_2 in value:
                            result_2.append(a_schema_5.load(
                                item_2, unknown=field_2.unknown, partial=nested_partial
                            ))
                        value = result_2
                    else:
                        value = a_schema_5.load(
                            value, unknown=field_2.unknown, partial=nested_partial
                        )
