# marshmallow.fields.IPv6Interface
def _jit_deserialize_SerializeIPv6InterfaceSchema_1(
                            self,
                            data: (
        ...
        try:
            if value is missing:
                ...
                if value is None:
                    ...
                    try:
                        value = (
                            field_2.DESERIALIZATION_CLASS or ipaddress.ip_interface
                        )(utils.ensure_text_type(value))
                    except (ValueError, TypeError) as error:
                        raise field_2.make_error("invalid_ip_interface") from error
