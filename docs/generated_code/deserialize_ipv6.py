# marshmallow.fields.IPv6
def _jit_deserialize_SerializeIPv6Schema_1(
                            self,
                            data: (
        ...
        try:
            if value is missing:
                ...
                if value is None:
                    ...
                    try:
                        value = (
                            field_2.DESERIALIZATION_CLASS or ipaddress.ip_address
                        )(utils.ensure_text_type(value))
                    except (ValueError, TypeError) as error:
                        raise field_2.make_error("invalid_ip") from error
